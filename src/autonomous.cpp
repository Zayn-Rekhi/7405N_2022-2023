...
void right_side() {
    ...
    Robot::power.set_value(6.5, 0.01, 0, 2, 10);
    Robot::turn.set_value(0, 0, 0.0, 0, 0.0);
    Robot::drive.move_to(Pose(29.2, -2), 3, 90, 1000, 2000);
...
void left_side() {
    ...
    Robot::flywheel.set_velocity(2150);
...
//
    ...
    Robot::drive.rotate_to(49.5, 0.5);
     ...
     Robot::power.set_value(6.5, 0.01, 0, 2, 10);
     Robot::turn.set_value(0, 0, 0.0, 0, 0.0);
     Robot::drive.move_to(Pose(27.04, 25.42), 3, 10000, 75, 1000); // 0, -5
...
//
    ...
    Robot::drive.move_to(Pose(46.2, 40.8), 3, 10000, 50); // 0, -5
     ...
     Robot::drive.rotate_to(-33.5, 0.5);
